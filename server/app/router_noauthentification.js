...
const router_noauthentification = Router();
 ...
 */
router_noauthentification.post('/login', validateBody(loginSchema.newLogin), userController.login);
 ...
 */
router_noauthentification.get('/logout', userController.logout);
 ...
 */
router_noauthentification.get('/themes', themeController.getAllThemes);
 ...
 */
router_noauthentification.get('/themes/:id(\\d+)', themeController.getOneTheme);
 ...
 */
router_noauthentification.post('/admin/themes', validateBody(themeSchema.newTheme), themeController.addNewTheme);
 ...
 */
router_noauthentification.post('/admin/themes/:themeId(\\d+)', validateBody(themeSchema.updateTheme), themeController.changeTheme);
 ...
 */
router_noauthentification.delete('/admin/themes/:themeId(\\d+)', themeController.deleteTheme);
//
//
// --------------------------------------END THEME ROUTE------------------------------------------
//
 ...
 */
router_noauthentification.get('/missions', missionController.getAllMissions);
 ...
 */
router_noauthentification.get('/missions/:id(\\d+)', missionController.getOneMission);
 ...
 * @returns {Array<Mission>} 200 - An array of missions
 */
router_noauthentification.get('/themes/:id(\\d+)/missions',  missionController.getAllByThemeId);
 ...
 */
router_noauthentification.post('/admin/themes/:themeId(\\d+)/missions',  validateBody(missionSchema.newMission), missionController.addMission);
 ...
 */
router_noauthentification.post('/admin/missions/:missionId(\\d+)',  validateBody(missionSchema.updateMission), missionController.modifyMission);
 ...
 */
router_noauthentification.delete('/admin/missions/:missionId(\\d+)', missionController.deleteMission);
 ...
 */
router_noauthentification.get('/students/:userId(\\d+)/themes/:themeId(\\d+)/score', interactController.getScorebyThemeAndUser);
 ...
 */
router_noauthentification.get('/students/:userId(\\d+)/score', interactController.getGlobalScoreByUser);
 ...
 */
router_noauthentification.get('/missions/users/:userId(\\d+)',  interactController.getAllByUserId);
 ...
 */
router_noauthentification.get('/missions/:missionId(\\d+)/users/:userId(\\d+)',  interactController.getOneByMissionAndUser);
 ...
 * @returns {<Interact>} 200 - One instance of the Interact class
 */
router_noauthentification.post('/student/interact/', validateBody(interactSchema.newInteract), interactController.checkBox);
...
router_noauthentification.delete('/student/interact/missions/:missionId(\\d+)/users/:userId(\\d+)', interactController.uncheckBox);
//
//
// --------------------------------------END INTERACT ROUTE------------------------------------------
 ...
 */
router_noauthentification.get('/users', userController.getAllusers);
 ...
 */
router_noauthentification.get('/users/:id(\\d+)', userController.getOneUser);
 ...
 */
router_noauthentification.post('/admin/add', adminController.addAdmin);
 ...
 */
router_noauthentification.get('/admin/students', adminController.getAllStudentsWithPromo);
//
//
// --------------------------------------END------------------------------------------

module.exports = router_noauthentification;
